...
<body class="rtl">
		...
		<div id="top_line">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-6">
                        <ul id="top_links">
                            <li><a href="single_hotel_contact.php#sign-in-dialog" id="access_link">Sign in</a></li>
			...
			<div class="row">
				...
				<nav class="col-9">
                    ...
                    <div class="main-menu">
                        ...
                        <a href="single_hotel_contact.php#" class="open_close" id="close_in"><i class="icon_set_1_icon-77"></i></a>
                       <ul>
                            <li class="submenu">
                    ...
                    <ul id="top_tools">
                        ...
                        <li>
                            <div class="dropdown dropdown-cart">
                                <a href="single_hotel_contact.php#" data-toggle="dropdown" class="cart_bt"><i class="icon_bag_alt"></i><strong>3</strong></a>
                                <ul class="dropdown-menu" id="cart_items">
                                    <li>
                                        <div class="image"><img src="img/thumb_cart_1.jpg" alt="image"></div>
                                        <strong><a href="single_hotel_contact.php#">Louvre museum</a>1x $36.00 </strong>
                                        <a href="single_hotel_contact.php#" class="action"><i class="icon-trash"></i></a>
                                    </li>
                                    <li>
                                        <div class="image"><img src="img/thumb_cart_2.jpg" alt="image"></div>
                                        <strong><a href="single_hotel_contact.php#">Versailles tour</a>2x $36.00 </strong>
                                        <a href="single_hotel_contact.php#" class="action"><i class="icon-trash"></i></a>
                                    </li>
                                    <li>
                                        <div class="image"><img src="img/thumb_cart_3.jpg" alt="image"></div>
                                        <strong><a href="single_hotel_contact.php#">Versailles tour</a>1x $36.00 </strong>
                                        <a href="single_hotel_contact.php#" class="action"><i class="icon-trash"></i></a>
                                    </li>
                                    <li>
    ...
    <div id="position">
		<div class="container">
			<ul>
				<li><a href="single_hotel_contact.php#">Home</a>
				</li>
				<li><a href="single_hotel_contact.php#">Category</a>
				</li>
				<li>Page active</li>
			</ul>
		</div>
    ...
    <div class="row">
        <div class="col-lg-8" id="single_tour_desc">
					...
					<p class="d-none d-md-block d-block d-lg-none"><a class="btn_map" data-toggle="collapse" href="single_hotel_contact.php#collapseMap" aria-expanded="false" aria-controls="collapseMap" data-text-swap="Hide map" data-text-original="View on map">View on map</a>
					</p>
					...
					<div class="row">
						<div class="col-lg-3">
							<h3>Reviews</h3>
							<a href="single_hotel_contact.php#" class="btn_1 add_bottom_30" data-toggle="modal" data-target="#myReview">Leave a review</a>
						</div>
						<div class="col-lg-9">
				...
				<p class="d-none d-xl-block d-lg-block d-xl-none">
					<a class="btn_map" data-toggle="collapse" href="single_hotel_contact.php#collapseMap" aria-expanded="false" aria-controls="collapseMap" data-text-swap="Hide map" data-text-original="View on map">View on map</a>
				</p>
				<div class="box_style_1 expose">
								<form id="booking_hotel" action="single_hotel_contact.php" method="post">
					...
					<a class="btn_full_outline" href="single_hotel_contact.php#"><i class=" icon-heart"></i> Add to whislist</a>
					</form>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-3">
                    <h3>About</h3>
                    <ul>
                        <li><a href="single_hotel_contact.php#">About us</a></li>
                        <li><a href="single_hotel_contact.php#">FAQ</a></li>
                        <li><a href="single_hotel_contact.php#">Login</a></li>
                        <li><a href="single_hotel_contact.php#">Register</a></li>
                         <li><a href="single_hotel_contact.php#">Terms and condition</a></li>
                    </ul>
                </div>
                <div class="col-md-3">
                    <h3>Discover</h3>
                    <ul>
                        <li><a href="single_hotel_contact.php#">Community blog</a></li>
                        <li><a href="single_hotel_contact.php#">Tour guide</a></li>
                        <li><a href="single_hotel_contact.php#">Wishlist</a></li>
                         <li><a href="single_hotel_contact.php#">Gallery</a></li>
                    </ul>
                </div>
                <div class="col-md-2">
                    <h3>Settings</h3>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div id="social_footer">
                        <ul>
                            <li><a href="single_hotel_contact.php#"><i class="icon-facebook"></i></a></li>
                            <li><a href="single_hotel_contact.php#"><i class="icon-twitter"></i></a></li>
                            <li><a href="single_hotel_contact.php#"><i class="icon-google"></i></a></li>
                            <li><a href="single_hotel_contact.php#"><i class="icon-instagram"></i></a></li>
                            <li><a href="single_hotel_contact.php#"><i class="icon-pinterest"></i></a></li>
                            <li><a href="single_hotel_contact.php#"><i class="icon-vimeo"></i></a></li>
                            <li><a href="single_hotel_contact.php#"><i class="icon-youtube-play"></i></a></li>
                        </ul>
                        <p>© Citytours 2018</p>
                    </div>
                </div>
	...
	<div id="sign-in-dialog" class="zoom-anim-dialog mfp-hide">
		...
		<form>
			<div class="sign-in-wrapper">
				<a href="single_hotel_contact.php#0" class="social_bt facebook">Login with Facebook</a>
				<a href="single_hotel_contact.php#0" class="social_bt google">Login with Google</a>
